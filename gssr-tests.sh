...
python3 gssr-analyze.py -i test-report-05 -o test-report-05.pdf

fi

exit
srun -N2 -n6 ./gssr-record -o test-report-01 /usr/bin/dcgmproftester12 -t 1006 -d 20 \
    && python3 gssr-analyze.py -i test-report-01 -o test-report-01.pdf
